...
public class ImageUtils {
    ...
    public  static String saveBitmap(final Bitmap bitmap) {
        ...
        final String root =
                ...
                Constants.getModelDirectoryPath()+"/image";
...
//        final String fname = Phone_number+"_"+"Facephoto" + ".jpg";
        final String fname = Contact_info+"_"+"Facephoto_only_registered" + ".jpg";
...
//            Timber.tag(TAG).e("Exception!", e);
    ...
    public  static String saveBitmap2(final Bitmap bitmap) {
...
//        }
        ...
        final String fname = Contact_info+"_"+"Facephoto_only" + ".jpg";
        final File file = new File(myDir, fname);
        if (file.exists()) {
            file.delete();
        }
