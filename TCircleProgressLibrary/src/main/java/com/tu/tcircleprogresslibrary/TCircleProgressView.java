...
public class TCircleProgressView extends View {
    ...
    private void initScale() {
        ...
        if (height == width) {
            ...
            if (mRectFCircle == null) {
                mRectFCircle = new RectF(mBorderWidthHalf+(mTransparentCircleCX-mTransparentCircleCX/1.2f), mBorderWidthHalf + 0, rectRB-(mTransparentCircleCX-mTransparentCircleCX/1.2f), rectRB);
            }
            ...
            if (mRectFCircle == null) {
                mRectFCircle = new RectF(mBorderWidthHalf+(mTransparentCircleCX-mTransparentCircleCX/1.2f), mBorderWidthHalf + offset, rectRB-(mTransparentCircleCX-mTransparentCircleCX/1.2f), rectRB + offset);
            }
            if (mHintRectFSemicircle == null) {
                mHintRectFSemicircle = new RectF(mRectFCircle.left + mBorderWidthHalf + gapOffset,
                        mRectFCircle.top + mBorderWidthHalf + gapOffset,
            ...
            mTransparentCircleRadius = mMinDiameterHalf - mBorderWidth - gapOffset;
            if (mRectFCircle == null) {
                mRectFCircle = new RectF(mBorderWidthHalf + offset+(mTransparentCircleCX-mTransparentCircleCX/1.2f), mBorderWidthHalf + 0, rectRB + offset-(mTransparentCircleCX-mTransparentCircleCX/1.2f), rectRB);
            }
            if (mHintRectFSemicircle == null) {
                mHintRectFSemicircle = new RectF(mRectFCircle.left + mBorderWidthHalf + gapOffset,
                        mRectFCircle.top + mBorderWidthHalf + gapOffset,
    ...
    private void drawbg(Canvas canvas) {
        RectF r= new RectF(mTransparentCircleCX-mTransparentCircleRadius/1.2f,mTransparentCircleCY-mTransparentCircleRadius,mTransparentCircleCX+mTransparentCircleRadius/1.2f,mTransparentCircleCY+mTransparentCircleRadius);
        Paint paint = new Paint();
